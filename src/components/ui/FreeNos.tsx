...
const AnimatedGenerateButton: React.FC<AnimatedGenerateButtonProps> = ({
  ...
  // Measure the longer of the two labels to size the wrapper correctly
  const longerLabel = labelIdle.length >= labelActive.length ? labelIdle : labelActive;
  ...
  return (
    <div className={clsx("relative inline-block", className)} id={id}>
      ...
      >
        ...
        {/*
          Key fix: replace the hard-coded min-w-[10.3em] with a hidden "sizer" span
          that always renders the longer label invisibly, so the wrapper is always
          wide enough for whichever label is currently visible.
        */}
        <div className="ui-anim-txt-wrapper relative flex items-center whitespace-nowrap">
          {/* Invisible sizer — reserves space for the longest label */}
          ...
          <div
            className={clsx(
              "ui-anim-txt-1 absolute inset-0 flex items-center",
          ...
          <div
            className={clsx(
              "ui-anim-txt-2 absolute inset-0 flex items-center",
      ...
      <style>{`
        ...
        .ui-anim-txt-2 .ui-anim-letter:nth-child(16) { animation-delay: 1.2s; }
        .ui-anim-txt-1 .ui-anim-letter:nth-child(17),
        .ui-anim-txt-2 .ui-anim-letter:nth-child(17) { animation-delay: 1.28s; }
        .ui-anim-txt-1 .ui-anim-letter:nth-child(18),
        .ui-anim-txt-2 .ui-anim-letter:nth-child(18) { animation-delay: 1.36s; }
        .ui-anim-txt-1 .ui-anim-letter:nth-child(19),
        .ui-anim-txt-2 .ui-anim-letter:nth-child(19) { animation-delay: 1.44s; }
        .ui-anim-txt-1 .ui-anim-letter:nth-child(20),
        .ui-anim-txt-2 .ui-anim-letter:nth-child(20) { animation-delay: 1.52s; }
        .ui-anim-txt-1 .ui-anim-letter:nth-child(n+21),
        .ui-anim-txt-2 .ui-anim-letter:nth-child(n+21) { animation-delay: 1.6s; }
